...
The zoning process accepts input dataset of class `SpatialPointsDataFrame` or `SpatialMultiPointsDataFrame` of the [sp](https://cran.r-project.org/package=sp) R package.<br>
...
uncomment and replace tempdir() with the directory you want to export the map
